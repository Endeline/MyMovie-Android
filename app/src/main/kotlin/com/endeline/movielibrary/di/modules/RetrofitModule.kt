...
import com.endeline.movielibrary.data.Constants.Api.API_KEY_PARAM
import com.endeline.movielibrary.data.Constants.Api.TIMEOUT_SECOND
...
class RetrofitModule {
    ...
    @Provides
    fun provideRetrofitService(): ProductRepository = Retrofit.Builder()
